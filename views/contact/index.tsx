...
const ContactInput = ({ className }: { className?: string }) => {
  return (
    <input
      ...
      type="text"
      className={`px-3 text-center border-b dark:border-white border-gray-600 bg-transparent outline-none ${className}`}
    />
  );
};
      ...
      <div className="mb-[120px] pb-[120px]">
        ...
        <form action="">
          ...
          >
            Send{" "}
            <Icon
              className="dark:!bg-[#E0E0E0] !bg-black group-hover:!bg-brand group-hover:scale-125 duration-200"
              size={40}
